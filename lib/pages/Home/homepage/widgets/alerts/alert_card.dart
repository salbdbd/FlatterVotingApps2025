    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [
            AppConstants.cardBackground.withValues(alpha: 0.8),
            AppConstants.cardBackgroundSecondary.withValues(alpha: 0.9),
          ],
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          gradient: _showOnlyUnread
              ...
              : null,
          color: _showOnlyUnread ? null : Colors.white.withValues(alpha: 0.1),
          borderRadius: BorderRadius.circular(12),
          border: Border.all(
                ...
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    colors: [
                      ...
                      AppConstants.secondaryPurple.withValues(alpha: 0.2),
                    ],
                  ),
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [
            AppConstants.cardBackground.withValues(alpha: 0.7),
            AppConstants.cardBackgroundSecondary.withValues(alpha: 0.9),
          ],
          begin: Alignment.topLeft,
          end: Alignment.bottomRight,
        ...
        border: Border.all(
          color: isRead
              ? Colors.transparent
              : AppConstants.primaryPurple.withValues(alpha: 0.4),
          width: 1.5,
        ),
        boxShadow: [
          BoxShadow(
